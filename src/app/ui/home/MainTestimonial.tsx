            ...
            <div className="container flex flex-col items-center p-4 mx-auto space-y-6 md:p-8">
                ...
                <div className="flex justify-center space-x-3">
                    <Image
                        ...
                        className="bg-center bg-cover rounded-md bg-gray-500"
                        alt="Testimonial"
                        width={80}
                        height={80}
                        />
                    <div>
                        ...
                        <p className="text-sm leading-tight text-gray-700">Gerente de Tostao</p>
                        <a className="flex items-center py-2 space-x-1 text-sm text-violet-600" href="/">
