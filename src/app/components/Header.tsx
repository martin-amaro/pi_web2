            ...
            <div className="w-full mx-auto flex justify-between items-center px-3 py-2 md:px-12 max-w-[1900px]">
                <div className="flex items-center gap-10">
                    ...
                    <nav className="hidden lg:block">
                        <ul className='flex gap-4 font-medium text-gray-300'>
                            <li> <NavLink href="/restaurantes">Restaurantes</NavLink> </li>
                            <li> <NavLink href="/retail">Retail</NavLink> </li>
                            <li> <NavLink href="/belleza">Belleza</NavLink> </li>
                            <li> <NavLink href="#" >Servicios</NavLink> </li>
                            <li> <NavLink href="/pricing">Planes</NavLink> </li>
                        </ul>
                    </nav>
                ...
                <div className={"hidden lg:block"}>
                    <ul className='flex items-center gap-3'>
                        <>
                            <li>
                                <NavLink className="flex gap-2" href="/login">
                                    <CircleUserRound />
                                    Ingresar
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="header-link flex gap-2" href="#">
...
const NavLink = ({ children, href, className=null }: { children: ReactNode, href: string, className?:string|null }) => (
    <Link className={"header-link " + (className ? className : '')} href={href}>
        { children }
    </Link>
)